...
# Experimento 1A
PARAM$experimento  <- "ZZ6910E"
PARAM$exp_input  <- "HT6510B"
-----------------------------
# Experimento 1B
PARAM$experimento  <- "ZZ6911B"
PARAM$exp_input  <- "HT6511A"
PARAM$experimento  <- "ZZ6911D"
PARAM$exp_input  <- "HT6511A"
# Experimento 2

PARAM$modelos  <- 2       #aumentar si se quieren mas modelos
PARAM$semilla  <- 100109  # siempre se debera probar con 5 semillas, en 5 experimentos distintos, y presentar la media y/o los graficos detallados de las cinco curvas si corresponde
