...
archivo_salida  <- "./exp/HT2020/gridsearch11.txt"
...

{
  ...
  {
    for( vmin_split in c( 1600, 1000, 800, 600, 400, 200, 100, 50, 20, 10 ) )
    {
      for(vmin_bucket in c(2,4,8,16,32,vmin_split/4,vmin_split/2))
      {
