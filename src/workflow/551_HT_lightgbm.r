...
PARAM$bo_lgb <- makeParamSet( 
         ...
         makeNumericParam("lambda_l1",    lower=    0.001, upper=     0.01),
         makeNumericParam("lambda_l2",    lower=    0.001, upper=     0.01)
#         lambda_l1= 0.005,                 # lambda_l1 >= 0.0
#         lambda_l2= 0.005,                 # lambda_l2 >= 0.0
        )


#si usted es ambicioso, y tiene paciencia, podria subir este valor a 100
PARAM$bo_iteraciones  <- 67  #iteraciones de la Optimizacion Bayesiana
