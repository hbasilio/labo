...
PARAM <- list()
PARAM$experimento  <- 230417
PARAM$semilla  <- 671332      #Establezco la semilla aleatoria, cambiar por SU primer semilla
...
for( arbolito in  1:PARAM$num_trees_max )
{
  ...
  if( arbolito %in%  grabar )
  {
    ...
    nom_arch  <- paste0('HB', PARAM$experimento, "_",
